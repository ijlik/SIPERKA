...
public class lahan extends javax.swing.JFrame {
    ...
    public String getNama_lahan() {
        return Nama_lahan.getText();
    }

    public String getLuas_lahan() {
        return Luas_lahan.getText();
    }

    public String getPh_tanah() {
        return Ph_tanah.getText();
    }
    ...
    public void setNama_lahan(String Nama_lahan) {
        this.Nama_lahan.setText(Nama_lahan);
    }

    public void setLuas_lahan(String Luas_lahan) {
        this.Luas_lahan.setText(Luas_lahan);
    }

    public void setPh_tanah(String Ph_tanah) {
        this.Ph_tanah.setText(Ph_tanah);
    }
    ...
    public void setNama_sektor(String Nama_sektor) {
        this.Nama_sektor.setText(Nama_sektor);
    }
    ...
    private void initComponents() {
        ...
        Nama_lahan = new javax.swing.JTextField();
        Luas_lahan = new javax.swing.JTextField();
        Ph_tanah = new javax.swing.JTextField();
        Nama_sektor = new javax.swing.JTextField();
        ...
        IDlahan = new javax.swing.JLabel();
        ...
        getContentPane().add(Nama_lahan, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 220, 110, -1));
        getContentPane().add(Luas_lahan, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 250, 110, -1));

        Ph_tanah.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Ph_tanahActionPerformed(evt);
            }
        });
        getContentPane().add(Ph_tanah, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, 110, -1));
        getContentPane().add(Nama_sektor, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 340, 110, -1));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 250, 80, -1));

        jLabel4.setFont(new java.awt.Font("Tempus Sans ITC", 3, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("PH tanah");
        jLabel4.setToolTipText("");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, 70, -1));

        jLabel5.setFont(new java.awt.Font("Tempus Sans ITC", 3, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("ID sektor");
        jLabel5.setToolTipText("");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 310, 80, -1));

        jLabel6.setFont(new java.awt.Font("Tempus Sans ITC", 3, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("Nama sektor");
        jLabel6.setToolTipText("");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 340, 90, -1));
        ...
        jLabel9.setText("Nama lahan");
        jLabel9.setToolTipText("");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 220, 90, -1));
        ...
        getContentPane().add(IDlahan, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 194, 110, 20));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/siperka/view/lahan.png"))); // NOI18N
    ...
    private void Ph_tanahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Ph_tanahActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Ph_tanahActionPerformed
    ...
    private javax.swing.JLabel IDlahan;
    private javax.swing.JTextField IDsektor;
    private javax.swing.JTextField Luas_lahan;
    private javax.swing.JTextField Nama_lahan;
    private javax.swing.JTextField Nama_sektor;
    private javax.swing.JTextField Ph_tanah;
